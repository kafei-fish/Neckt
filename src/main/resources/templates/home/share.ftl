...
<title>${siteName!""}|用户【${share.user.username!""}】分享文件-${share.title!""}</title>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <ul class="topbar-right">
            <#if ylrc_user??>
            <li class="dropdown dropdown-profile" id="logined-id" data-key="${ylrc_user.id}">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <#if ylrc_auth != 1>
                <div class="alert alert-danger" role="alert" id="show-copyright">
                	<p class="h6 text-primary m-t-0">${showTipsText}</p>
                    <p class="h3 text-primary m-b-0">${showTipsUrlText}<a href="${showTipsUtl}" style="color:red;margin-right:20px;">https://www.yuanlrc.com</a><a href="javascript:void(0)" class="btn btn-danger" id="order-auth-btn">${showTipsBtnText}</a></p>
                    <p class="h5 text-primary m-b-0"></p>
                </div>
                </#if>
